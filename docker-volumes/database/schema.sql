...
create table user (id varchar(255) not null, creation_time datetime not null, last_update_time datetime, name varchar(255) not null, last_audio_stream datetime, enabled bit, expired bit, expired_credentials bit, locked bit, password varchar(60) not null, role varchar(255), username varchar(32) not null, thumbnail_id varchar(255), primary key (id));
