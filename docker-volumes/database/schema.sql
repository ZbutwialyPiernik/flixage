create table album (id varchar(255) not null, creation_time datetime not null, update_time datetime, name varchar(255) not null, thumbnail_id varchar(255), artist_id varchar(255), primary key (id));
create table artist (id varchar(255) not null, creation_time datetime not null, update_time datetime, name varchar(255) not null, thumbnail_id varchar(255), primary key (id));
