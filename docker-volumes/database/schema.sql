...
create table track (id varchar(255) not null, creation_time datetime not null, last_update_time datetime, name varchar(255) not null, genre varchar(255), stream_count bigint not null, last_audio_stream datetime, thumbnail_id varchar(255), album_id varchar(255), artist_id varchar(255), audio_file_id varchar(255), album varchar(255), primary key (id));
