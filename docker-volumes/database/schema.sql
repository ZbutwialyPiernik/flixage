...
create table audio_file_entity (id varchar(255) not null, creation_time datetime not null, last_update_time datetime, extension varchar(255), file_id varchar(255), mime_type varchar(255), size bigint not null, duration bigint not null, primary key (id));
create table image_file_entity (id varchar(255) not null, creation_time datetime not null, last_update_time datetime, extension varchar(255), file_id varchar(255), mime_type varchar(255), size bigint not null, height bigint not null, width bigint not null, primary key (id));
...
create table track (id varchar(255) not null, creation_time datetime not null, last_update_time datetime, name varchar(255) not null, genre varchar(255), play_count bigint not null, thumbnail_id varchar(255), album_id varchar(255), artist_id varchar(255), audio_file_id varchar(255), album varchar(255), primary key (id));
create table user (id varchar(255) not null, creation_time datetime not null, last_update_time datetime, name varchar(255) not null, enabled bit, expired bit, expired_credentials bit, locked bit, password varchar(60) not null, role varchar(255), username varchar(32) not null, thumbnail_id varchar(255), primary key (id));
...
alter table album add constraint FK6v7kfmm72rhnr7b3liclhve2m foreign key (thumbnail_id) references image_file_entity (id);
alter table album add constraint FKmwc4fyyxb6tfi0qba26gcf8s1 foreign key (artist_id) references artist (id);
alter table artist add constraint FKs1ofurr76jy089nnu405mqf29 foreign key (thumbnail_id) references image_file_entity (id);
alter table playlist add constraint FK71cyct8hycd1lom1xfowqc1p3 foreign key (thumbnail_id) references image_file_entity (id);
...
alter table track add constraint FK9pe1j3hx824le458x3ugy2wag foreign key (thumbnail_id) references image_file_entity (id);
...
alter table track add constraint FKspe3cvw3t6sbyw4ah2mw0ojy2 foreign key (audio_file_id) references audio_file_entity (id);
alter table track add constraint FKrdqpaxtar239vj2gngp8e5ujx foreign key (album) references album (id);
alter table user add constraint FKl1wprtaec08rg3lgbw6kj187a foreign key (thumbnail_id) references image_file_entity (id);
