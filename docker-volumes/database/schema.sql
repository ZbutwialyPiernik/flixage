...
create table audio_file_entity (id varchar(255) not null, creation_time datetime not null, last_update_time datetime, extension varchar(255), file_id varchar(255), mime_type varchar(255), size bigint, duration bigint not null, primary key (id));
create table image_file_entity (id varchar(255) not null, creation_time datetime not null, last_update_time datetime, extension varchar(255), file_id varchar(255), mime_type varchar(255), size bigint, height bigint, width bigint, primary key (id));
...
create table track (id varchar(255) not null, creation_time datetime not null, last_update_time datetime, name varchar(255) not null, genre varchar(255), play_count bigint, thumbnail_id varchar(255), album_id varchar(255), artist_id varchar(255), audio_file_id varchar(255), album varchar(255), primary key (id));
