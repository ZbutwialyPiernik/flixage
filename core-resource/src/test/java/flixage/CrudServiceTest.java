...
public class CrudServiceTest {
    ...
    public void entity_without_id_does_get_created() {
        ...
        Assertions.assertEquals(entity.getCreationTime(), creationTime);
        Assertions.assertEquals(entity.getLastUpdateTime(), creationTime);
    }
    ...
    public void entity_does_get_updated_when_entity_exists_in_database() {
        ...
        Assertions.assertEquals(entity.getCreationTime(),creationTime);
        Assertions.assertEquals(entity.getLastUpdateTime(),updateTime);
    }
    ...
    public void entity_does_not_get_updated_when_entity_has_other_creation_time_than_existing_in_database() {
        ...
        Mockito.verify(repository, Mockito.never()).save(Mockito.any());
        Assertions.assertEquals(entity.getCreationTime(), newCreationTime);
        Assertions.assertEquals(entity.getLastUpdateTime(), creationTime);
    }
